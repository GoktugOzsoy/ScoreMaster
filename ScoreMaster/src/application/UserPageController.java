...
public class UserPageController implements Initializable {
    	...
    	if(login_username.getText().isEmpty()
    		...
    		try {
    			...
    			if(result.next()) {
    				...
    				//giriş yaptıktan sonra kullanıcı sayfasını göstermek için
    				Parent root = FXMLLoader.load(getClass().getResource("UserScreenpage.fxml"));
 ...
 // userlist e basınca sayfa değiştirme kodları
    public void switchPage() {
    	...
    	if ("Admin Portal".equals(login_selectUser.getSelectionModel().getSelectedItem())) {
    	...
    	}else if ("User Portal".equals(login_selectUser.getSelectionModel().getSelectedItem())) {
